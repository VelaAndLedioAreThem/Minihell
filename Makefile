...
#    Updated: 2025/06/21 15:04:02 by ldurmish         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = $(SRC)main.c $(SRC)main_utils.c $(TREE)tree.c $(TOKENIZE)tokenize.c \
	   ...
	   $(PARSE_UTILS)errors_free.c $(TOKENIZE)tokenize_utils_2.c $(ENV)convert_env.c \
	   ...
	   $(BUILTINS)utils/builtins_path_utils.c $(BUILTINS)utils/builtins_path_utils_2.c $(BUILTINS)utils/builtins_path_utils_3.c $(EXEC)redirections/heredoc_handling.c $(EXEC)redirections/heredoc_handling_utils.c \
	   ...
	   $(PARENTHESIS)parenthesis_utils_3.c $(TREE)tree_utils_2.c\
